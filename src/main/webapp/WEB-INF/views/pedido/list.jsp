	...
	<div class="container">
		<div class="card">
		  ...
		  <div class="card-body">
		   ...
		   <button class="btn btn-warning"onclick="alterarStatus(${pedido.id},'ENTREGA')">Enviar para Entrega</button>
		  </div>
		</div>
	</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<table class="table">
					 ...
					 <button class="btn btn-warning"onclick="alterarStatus(${pedido.id},'FINALIZADO')">Pedido Entregue</button>
				</div>
			</div>
		</div>
